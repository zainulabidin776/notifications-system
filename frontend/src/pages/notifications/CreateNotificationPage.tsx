  ...
  const handleSubmit =
    async (
      ...
      try {
         ...
         * Important:
         *
         * We use the NotificationsProvider
         * instead of calling notificationsApi
         * directly.
         *
         * The provider:
         * 1. sends POST /notifications
         * 2. receives the created notification
         * 3. adds it to shared React state
         *
         * Dashboard, notification list and
         * banners then update immediately.
         */
